...
module.exports = env => {
    ...
    const config = {
        ...
        entry: {
            "main": "./src/compliance-check/main.ts",
        },
        ...
        plugins: [
            new CopyWebpackPlugin([
                // These files are needed by azure-pipelines-task-lib library.
                {
                    ...
                    to: path.join(Target, "compliance-check")
                },
                {
                ...
                {
                    from: path.join(__dirname, "./src/compliance-check/task.json"),
                    to: path.join(Target, "compliance-check")
                },
                {
                    from: path.join(__dirname, "./images/icon.png"),
                    to: path.join(Target, "compliance-check", "icon.png")
                },
                {
            ...
            WebpackCommon.PackageJsonLoadFixer(Target, [
                "compliance-check/main.js",
            ]),

            WebpackCommon.VersionStringReplacer(Target, [
                "compliance-check/task.json",
                "base.json"
            ]),
    ...
    return WebpackCommon.FillDefaultNodeSettings(config, env, "compliance-check");
};
